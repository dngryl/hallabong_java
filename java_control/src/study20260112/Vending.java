...
public class Vending {
	...
	// toString과  매개 변수있는 생성자 메서드, 각 변수들의 set, get 메서드 만들기
	...
	// 문제 1.
	// 음료를 구매하기 위해 돈을 넣었다.
	// 내가 넣은 돈으로 구매가 가능하면 수량을 1 감소시키세요. 
	
	public void buy (int Coin) {
		if (Coin >= this.price) // this를 붙이는 이유는?
			this.stock --;
	}
	
	// 문제 2.
	// 음료를 자판기에서 구매하는데
	// 수량이 충분한 지, 품절인지 확인 할 수 있는 메서드 만들기
	// 품절이면 "품절입니다." 출력 / 수량이 있으면 수량 출력
